...
AnswerGraphCtrl = function($scope, $http, $rootElement, $routeParams, $location) {
  ...
  render = function(values) {
    var area, dotGap, gradientW, h, maxDate, maxValue, minDate, minGap, minValue, offset, p, w, xAxis, yAxis;
    ...
    minDate = d3.min(date, function(d) {
      return d.date;
    });
    maxDate = d3.max(date, function(d) {
      return d.date;
    });
