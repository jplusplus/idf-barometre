...
AnswerGraphCtrl = function($scope, $http, $rootElement, $routeParams, $location) {
  ...
  render = function(values) {
    ...
    if (!Modernizr.svg) {
      ...
      svg.append("linearGradient").attr("id", "sequence-gradient").attr("gradientUnits", "userSpaceOnUse").attr("spreadMethod", "repeat").attr("y1", 0).attr("x1", 0).attr("y2", h).attr("x2", gradientW).selectAll("stop").data([
        {
          offset: "0%",
          color: "#ED9B0B",
          offset: "50%",
